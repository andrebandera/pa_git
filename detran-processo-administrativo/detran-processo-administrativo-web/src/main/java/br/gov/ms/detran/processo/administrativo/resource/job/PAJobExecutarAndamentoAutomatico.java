 ...
 */
public class PAJobExecutarAndamentoAutomatico extends DetranAbstractJob {
    ...
    protected void doJob(JobWrapper job) {
        try {
            List<ProcessoAdministrativo> processos = getProcessoAdministrativoService().
                    getListProcessosAdministrativosPorAndamento(DetranCollectionUtil.montaLista(
            ...
            Logger.getLogger(PAJobExecutarAndamentoAutomatico.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
