 ...
 * @author Lillydi.
 */
public class PAJobArquivarPASuspensaoPorCassacao extends DetranAbstractJob {

    private static final Logger LOG = Logger.getLogger(PAJobArquivarPASuspensaoPorCassacao.class);
    ...
    protected void doJob(JobWrapper job) {
        ...
        try {
            ...
            LOG.debug("Tratado.", e);
            getFalhaService().gravarFalha(e, "Erro ao executar Retorno AR");
