...
public class IdentificarLinhaCorreiosLegadoMain_Retorno_AR_FISICO_15_DIAS {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            List<String> pas 
                = FileUtils
                    .readLines(
                        new File("/home/desenvolvimento/DEV/scripts sql/20190605 - COMPLETO Linhas Correios - ITEM 02 - Tarefa #14899 - ARQUIVO FISICO - 15DIAS - PESQUISAR.txt"), 
                        "UTF-8"
                    );
                ...
                for (File file : listOfFiles) {
                    ...
                    for (String linha : listaLinhas) {
                        ...
                        if (linha.contains(pa)) {
                            ...
                            FileUtils
                                .writeStringToFile(
                                    new File("/home/desenvolvimento/DEV/scripts sql/20190605 - COMPLETO Linhas Correios - ITEM 02 - Tarefa #14899 - ARQUIVO FISICO - 15DIAS - PESQUISAR - ENCONTRADOS.txt"),
