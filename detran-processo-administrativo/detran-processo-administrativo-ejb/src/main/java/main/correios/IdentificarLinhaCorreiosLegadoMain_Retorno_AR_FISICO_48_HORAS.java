...
public class IdentificarLinhaCorreiosLegadoMain_Retorno_AR_FISICO_48_HORAS {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            List<String> pas 
                = FileUtils
                    .readLines(
                        new File("/home/desenvolvimento/DEV/scripts sql/20190605 - COMPLETO Linhas Correios - ITEM 02 - Tarefa #14899 - ARQUIVO FISICO - 48HORAS - PESQUISAR.txt"), 
                        "UTF-8"
                    );
                ...
                for (File file : listOfFiles) {
                    ...
                    for (String linha : listaLinhas) {
                        ...
                        if (linha.contains(pa)) {
                            ...
                            FileUtils
                                .writeStringToFile(
                                    new File("/home/desenvolvimento/DEV/scripts sql/20190605 - COMPLETO Linhas Correios - ITEM 02 - Tarefa #14899 - ARQUIVO FISICO - 48HORAS - PESQUISAR - ENCONTRADOS.txt"),
