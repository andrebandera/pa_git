...
public class IdentificarLinhaCorreiosLegadoMain_Retorno_AR_LOGICO {
...
//    private static final Logger LOG = Logger.getLogger(IdentificarLinhaCorreiosLegadoMain.class);
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            List<String> pas 
                = FileUtils
                    .readLines(new File("/home/desenvolvimento/DEV/scripts sql/20190605_ARQUIVO_LOGICO.txt"), "UTF-8");
                ...
                for (File file : listOfFiles) {
                    ...
                    for (String linha : listaLinhas) {
                        ...
                        if (linha.contains(pa)) {
                            ...
                            FileUtils
                                .writeStringToFile(
                                    new File("/home/desenvolvimento/DEV/scripts sql/20190605_ARQUIVO_LOGICO_ENCONTRADOS.txt"),
