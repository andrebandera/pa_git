...
import static br.gov.ms.detran.processo.administrativo.enums.TipoFasePaEnum.JARI;

/**
 *
 * @author desenvolvimento
 */
public class PAAndamento237  extends ExecucaoAndamento {

    private static final Logger LOG = Logger.getLogger(PAAndamento237.class);
    ...
    void validaEspecifico(EntityManager em, ExecucaoAndamentoEspecificoWrapper wrapper) throws AppException {
        ...
        new NotificacaoProcessoAdministrativoBO().validarNotificacaoDataLimiteExpirada(em, wrapper, JARI);
