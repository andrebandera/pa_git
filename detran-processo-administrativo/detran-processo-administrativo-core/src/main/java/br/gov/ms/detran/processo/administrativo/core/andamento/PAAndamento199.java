 ...
 */
public class PAAndamento199  extends ExecucaoAndamento {
    
    private static final Logger LOG = Logger.getLogger(PAAndamento199.class);
    ...
    public RetornoExecucaoAndamentoWrapper executaEspecifico(EntityManager em, ExecucaoAndamentoEspecificoWrapper wrapper) throws AppException {
        ...
        LOG.debug("Início Andamento 199. PA {0}", wrapper.getProcessoAdministrativo().getNumeroProcesso());
