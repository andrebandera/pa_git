 ...
 */
public class PAAndamento194  extends ExecucaoAndamento {
    
    private static final Logger LOG = Logger.getLogger(PAAndamento194.class);
    

    @Override
    public RetornoExecucaoAndamentoWrapper executaEspecifico(EntityManager em, ExecucaoAndamentoEspecificoWrapper wrapper) throws AppException {
        
        LOG.debug("Início Andamento 194.");
