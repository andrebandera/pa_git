 ...
 */
public class PAAndamento193  extends ExecucaoAndamento {
    
    private static final Logger LOG = Logger.getLogger(PAAndamento193.class);
    ...
    public void validaEspecifico(EntityManager em, ExecucaoAndamentoEspecificoWrapper wrapper) throws AppException {
        ...
        if(entrada == null || !TipoFasePaEnum.CURSO_EXAME.equals(entrada.getTipo())){
