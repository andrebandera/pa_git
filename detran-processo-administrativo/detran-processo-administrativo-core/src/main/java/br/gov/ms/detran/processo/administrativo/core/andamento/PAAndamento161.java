 ...
 */
public class PAAndamento161 extends ExecucaoAndamento {
    
    private static final Logger LOG = Logger.getLogger(PAAndamento161.class);
    ...
    public void validaEspecifico(EntityManager em,ExecucaoAndamentoEspecificoWrapper wrapper) throws AppException {
        ...
        if(movimentacao == null
                || !MovimentacaoAcaoEnum.RETIRAR_SUSPENSAO.equals(movimentacao.getMovimentacaoAcao())){
