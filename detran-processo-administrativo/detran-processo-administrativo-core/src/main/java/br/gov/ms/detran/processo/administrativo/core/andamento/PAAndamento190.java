 ...
 */
public class PAAndamento190  extends ExecucaoAndamento {
    
    private static final Logger LOG = Logger.getLogger(PAAndamento190.class);
    ...
    public RetornoExecucaoAndamentoWrapper executaEspecifico(EntityManager em, ExecucaoAndamentoEspecificoWrapper wrapper) throws AppException {
        ...
        LOG.debug("Início Andamento 190. PA {0}", wrapper.getProcessoAdministrativo().getNumeroProcesso());
