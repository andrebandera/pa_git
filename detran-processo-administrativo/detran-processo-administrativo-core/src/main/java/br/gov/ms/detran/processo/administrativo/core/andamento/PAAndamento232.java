 ...
 */
public class PAAndamento232  extends ExecucaoAndamento {
    
    private static final Logger LOG = Logger.getLogger(PAAndamento232.class);
    

    @Override
    public RetornoExecucaoAndamentoWrapper executaEspecifico(EntityManager em, ExecucaoAndamentoEspecificoWrapper wrapper) throws AppException {
        
        LOG.debug("Início Andamento 232. PA {0}", wrapper.getProcessoAdministrativo().getNumeroProcesso());
