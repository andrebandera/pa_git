 ...
 * @author Lillydi
 */
public class Instauracao_C7_SuspensaoReincidenciaMesmoArtigoForaPrazoBO extends InstauracaoCenario implements IInstauracaoCenario {

    private static final Logger LOG = Logger.getLogger(Instauracao_C7_SuspensaoReincidenciaMesmoArtigoForaPrazoBO.class);

    private final RegrasGeralInstauracaoCondutorBO regraGeralCondutorBO;

    public Instauracao_C7_SuspensaoReincidenciaMesmoArtigoForaPrazoBO() {
        super();
        ...
        if (!DetranCollectionUtil.ehNuloOuVazio(listaInfracoes)) {
            ...
            for (DadosInfracaoPAD infracao : listaInfracoes) {
                ...
                try {
                    ...
                    regraGeralInfracaoBO.validarMesmoArtigoInfracaoAposPeriodo1Ano(em, infracao, pasSuspensao);
