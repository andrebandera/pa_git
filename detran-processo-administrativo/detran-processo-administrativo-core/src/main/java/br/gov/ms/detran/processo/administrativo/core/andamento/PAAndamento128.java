 ...
 */
public class PAAndamento128  extends ExecucaoAndamento {
    
    private static final Logger LOG = Logger.getLogger(PAAndamento128.class);
    

    @Override
    public RetornoExecucaoAndamentoWrapper executaEspecifico(EntityManager em, ExecucaoAndamentoEspecificoWrapper wrapper) throws AppException {
        
        LOG.debug("Início Andamento 128. PA {0}", wrapper.getProcessoAdministrativo().getNumeroProcesso());
