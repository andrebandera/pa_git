 ...
 */
public class PAAndamento234  extends ExecucaoAndamento {
    
    private static final Logger LOG = Logger.getLogger(PAAndamento234.class);
    

    @Override
    public RetornoExecucaoAndamentoWrapper executaEspecifico(EntityManager em, ExecucaoAndamentoEspecificoWrapper wrapper) throws AppException {
        
        LOG.debug("Início Andamento 234. PA {0}", wrapper.getProcessoAdministrativo().getNumeroProcesso());
