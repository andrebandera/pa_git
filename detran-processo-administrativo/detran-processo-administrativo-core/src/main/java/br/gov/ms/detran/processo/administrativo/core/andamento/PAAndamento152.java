 ...
 */
public class PAAndamento152  extends ExecucaoAndamento {
    
    private static final Logger LOG = Logger.getLogger(PAAndamento152.class);
    

    @Override
    public RetornoExecucaoAndamentoWrapper executaEspecifico(EntityManager em, ExecucaoAndamentoEspecificoWrapper wrapper) throws AppException {
        
        LOG.debug("Início Andamento 152. PA {0}", wrapper.getProcessoAdministrativo().getNumeroProcesso());
    ...
    public void validaEspecifico(EntityManager em, ExecucaoAndamentoEspecificoWrapper wrapper) throws AppException {
        ...
        if(entrada == null || !TipoFasePaEnum.PROVIMENTO.equals(entrada.getTipo())){
