 ...
 */
public class PAAndamento136  extends ExecucaoAndamento {
    
    private static final Logger LOG = Logger.getLogger(PAAndamento136.class);
    
    @Override
    public RetornoExecucaoAndamentoWrapper executaEspecifico(EntityManager em, ExecucaoAndamentoEspecificoWrapper wrapper) throws AppException {

        LOG.debug("Início Andamento 136.");
        ...
        if (retornoWrapper == null) {
            ...
            if (npaWrapper == null || !TipoFasePaEnum.ENTREGA_CNH.equals(npaWrapper.getTipo())) {
