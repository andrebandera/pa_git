 ...
 */
public class PAAndamento163 extends ExecucaoAndamento {
    
    private static final Logger LOG = Logger.getLogger(PAAndamento163.class);
    ...
    public RetornoExecucaoAndamentoWrapper executaEspecifico(EntityManager em, ExecucaoAndamentoEspecificoWrapper wrapper) throws AppException {
        ...
        LOG.debug("Início Andamento 163.");
        ...
        if (!wrapper.getProcessoAdministrativo().isJuridico() 
            && !MovimentacaoMotivoEnum.PROCESSO_PRESCRITO.equals(movimentacaoWrapper.getMotivo()))
            new AEMNPP12BO().
                    prepararExecutarAEMNPP12(new MovimentacaoInfracaoPARepositorio().
    ...
    public void validaEspecifico(EntityManager em,ExecucaoAndamentoEspecificoWrapper wrapper) throws AppException {
        ...
        if(movimentacaoWrapper == null
                || (!MovimentacaoAcaoEnum.ARQUIVAR.equals(movimentacaoWrapper.getAcao())
                    && !MovimentacaoAcaoEnum.ARQUIVAR_COM_BLOQUEIO.equals(movimentacaoWrapper.getAcao()))){
