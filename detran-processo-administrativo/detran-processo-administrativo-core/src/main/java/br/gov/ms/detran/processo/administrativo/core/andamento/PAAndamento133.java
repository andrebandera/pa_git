 ...
 */
public class PAAndamento133  extends ExecucaoAndamento {
    
    private static final Logger LOG = Logger.getLogger(PAAndamento133.class);
    

    @Override
    public RetornoExecucaoAndamentoWrapper executaEspecifico(EntityManager em, ExecucaoAndamentoEspecificoWrapper wrapper) throws AppException {
        
        LOG.debug("Início Andamento 133. PA {0}", wrapper.getProcessoAdministrativo().getNumeroProcesso());
