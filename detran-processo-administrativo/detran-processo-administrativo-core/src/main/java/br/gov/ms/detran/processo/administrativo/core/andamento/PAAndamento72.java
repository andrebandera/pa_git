 ...
 */
public class PAAndamento72 extends ExecucaoAndamento {
    
    private static final Logger LOG = Logger.getLogger(PAAndamento72.class);
    ...
    public void validaEspecifico(EntityManager em,ExecucaoAndamentoEspecificoWrapper wrapper) throws AppException {
        ...
        if(movimentacaoWrapper == null
                ...
                || !MovimentacaoMotivoEnum.PENA_CUMPRIDA.equals(movimentacaoWrapper.getMotivo())){
