 ...
 */
public class PAAndamento123  extends ExecucaoAndamento {
    
    private static final Logger LOG = Logger.getLogger(PAAndamento123.class);
    ...
    public void validaEspecifico(EntityManager em, ExecucaoAndamentoEspecificoWrapper wrapper) throws AppException {
        ...
        if(entrada == null || !TipoFasePaEnum.INSTAURACAO.equals(entrada.getTipo())){
