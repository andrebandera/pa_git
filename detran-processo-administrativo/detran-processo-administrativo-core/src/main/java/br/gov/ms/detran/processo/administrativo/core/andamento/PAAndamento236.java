 ...
 */
public class PAAndamento236  extends ExecucaoAndamento {
    
    private static final Logger LOG = Logger.getLogger(PAAndamento236.class);
    

    @Override
    public RetornoExecucaoAndamentoWrapper executaEspecifico(EntityManager em, ExecucaoAndamentoEspecificoWrapper wrapper) throws AppException {
        
        LOG.debug("Início Andamento 236. PA {0}", wrapper.getProcessoAdministrativo().getNumeroProcesso());
    ...
    public void validaEspecifico(EntityManager em, ExecucaoAndamentoEspecificoWrapper wrapper) throws AppException {
        ...
        if(entrada == null || !TipoFasePaEnum.ENTREGA_CNH.equals(entrada.getTipo())){
