...
@Entity
public class FunctionProcessoAdministrativoBloqueio implements Serializable {
    ...
    public FunctionProcessoAdministrativoBloqueio() {
    }

    public FunctionProcessoAdministrativoBloqueio(Long idProcesso, String numeroProcesso, String cpf, String dataInicio, Integer valorPrazoCumprimentoPena, String origem) {
