...
import static br.gov.ms.detran.processo.administrativo.enums.TipoFasePaEnum.INSTAURACAO;

/**
 *
 * @author desenvolvimento
 */
public class PAAndamento231  extends ExecucaoAndamento {

    private static final Logger LOG = Logger.getLogger(PAAndamento231.class);
    ...
    void validaEspecifico(EntityManager em, ExecucaoAndamentoEspecificoWrapper wrapper) throws AppException {
        ...
        new NotificacaoProcessoAdministrativoBO().validarNotificacaoDataLimiteExpirada(em, wrapper, INSTAURACAO);
