 ...
 */
public class PAAndamento171  extends ExecucaoAndamento {
    
    private static final Logger LOG = Logger.getLogger(PAAndamento171.class);
    

    @Override
    public RetornoExecucaoAndamentoWrapper executaEspecifico(EntityManager em, ExecucaoAndamentoEspecificoWrapper wrapper) throws AppException {
        
        LOG.debug("Início Andamento 123. PA {0}", wrapper.getProcessoAdministrativo().getNumeroProcesso());
    ...
    public void validaEspecifico(EntityManager em, ExecucaoAndamentoEspecificoWrapper wrapper) throws AppException {
        ...
        if(entrada == null || !TipoFasePaEnum.DESENTRANHAMENTO.equals(entrada.getTipo())){
