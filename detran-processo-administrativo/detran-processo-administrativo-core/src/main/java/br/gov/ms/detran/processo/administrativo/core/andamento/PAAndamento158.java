 ...
 */
public class PAAndamento158  extends ExecucaoAndamento {
    
    private static final Logger LOG = Logger.getLogger(PAAndamento158.class);

    @Override
    public RetornoExecucaoAndamentoWrapper executaEspecifico(EntityManager em, ExecucaoAndamentoEspecificoWrapper wrapper) throws AppException {
        
        LOG.debug("Início Andamento 158. PA {0}", wrapper.getProcessoAdministrativo().getNumeroProcesso());
