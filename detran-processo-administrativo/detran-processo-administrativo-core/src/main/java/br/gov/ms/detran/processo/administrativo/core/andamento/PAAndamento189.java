...
public class PAAndamento189 extends ExecucaoAndamento {

    private static final Logger LOG = Logger.getLogger(PAAndamento189.class);
    ...
    RetornoExecucaoAndamentoWrapper executaEspecifico(EntityManager em, ExecucaoAndamentoEspecificoWrapper wrapper) throws AppException {
        ...
        LOG.debug("Início Andamento 189.");
