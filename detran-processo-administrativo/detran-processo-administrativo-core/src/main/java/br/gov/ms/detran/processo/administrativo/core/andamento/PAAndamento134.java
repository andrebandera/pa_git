 ...
 */
public class PAAndamento134  extends ExecucaoAndamento {
    
    private static final Logger LOG = Logger.getLogger(PAAndamento134.class);
    

    @Override
    public RetornoExecucaoAndamentoWrapper executaEspecifico(EntityManager em, ExecucaoAndamentoEspecificoWrapper wrapper) throws AppException {
        
        LOG.debug("Início Andamento 134. PA {0}", wrapper.getProcessoAdministrativo().getNumeroProcesso());
