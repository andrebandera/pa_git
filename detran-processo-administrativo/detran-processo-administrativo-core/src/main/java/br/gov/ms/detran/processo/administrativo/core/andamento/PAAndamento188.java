...
public class PAAndamento188 extends ExecucaoAndamento {

    private static final Logger LOG = Logger.getLogger(PAAndamento188.class);
    ...
    public RetornoExecucaoAndamentoWrapper executaEspecifico(EntityManager em,
        ...
        LOG.debug("Início Andamento 188.");
        ...
        new NotificacaoProcessoAdministrativoBO().notificar(em, wrapper.getProcessoAdministrativo(), TipoFasePaEnum.CURSO_EXAME);
