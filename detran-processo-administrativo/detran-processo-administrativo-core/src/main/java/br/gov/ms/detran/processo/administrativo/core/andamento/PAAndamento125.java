...
public class PAAndamento125 extends ExecucaoAndamento {

    private static final Logger LOG = Logger.getLogger(PAAndamento125.class);
    ...
    public RetornoExecucaoAndamentoWrapper executaEspecifico(EntityManager em,
        ...
        LOG.debug("Início Andamento 125.");
