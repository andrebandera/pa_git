...
public class PAAndamento205 extends ExecucaoAndamento {

    private static final Logger LOG = Logger.getLogger(PAAndamento205.class);
    ...
    public RetornoExecucaoAndamentoWrapper executaEspecifico(EntityManager em,
        ...
        LOG.debug("Início Andamento 205.");

        RetornoExecucaoAndamentoWrapper retornoWrapper = new ConfirmaRetornoARBO().defineRetornoAndamentoJARI(em, wrapper.getProcessoAdministrativo());
    ...
    public void validaEspecifico(EntityManager em, ExecucaoAndamentoEspecificoWrapper wrapper) throws AppException {
        ...
        if (!TipoFasePaEnum.JARI.equals(entrada.getTipo())) {
