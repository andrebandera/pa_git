...
public class PAAndamento54Test {
    
    private static final Logger LOG = Logger.getLogger(PAAndamento54Test.class);
    
    public PAAndamento54Test() {
    }
    
    @Rule
    public PAAndamentoRule myPAAndamentoRuleTest = new PAAndamentoRule(PAAndamentoEnum.ANDAMENTO_54);
