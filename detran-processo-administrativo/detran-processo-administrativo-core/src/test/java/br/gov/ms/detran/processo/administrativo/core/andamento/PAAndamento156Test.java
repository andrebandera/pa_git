 ...
 */
public class PAAndamento156Test {
    
    private static final Logger LOG = Logger.getLogger(PAAndamento156Test.class);
    
    public PAAndamento156Test() {
    }
    
    @Rule
    public PAAndamentoRule myPAAndamentoRuleTest = new PAAndamentoRule(PAAndamentoEnum.ANDAMENTO_156);
