...
public class PAAndamento120Test {
    
    private static final Logger LOG = Logger.getLogger(PAAndamento120Test.class);
    
    public PAAndamento120Test() {
    }
    
    @Rule
    public PAAndamentoRule myPAAndamentoRuleTest = new PAAndamentoRule(PAAndamentoEnum.ANDAMENTO_120);
