 ...
 */
public class PAAndamento127Test {
    
    private static final Logger LOG = Logger.getLogger(PAAndamento127Test.class);
    
    public PAAndamento127Test() {
    }
    
    @Rule
    public PAAndamentoRule myPAAndamentoRuleTest = new PAAndamentoRule(PAAndamentoEnum.ANDAMENTO_127);
