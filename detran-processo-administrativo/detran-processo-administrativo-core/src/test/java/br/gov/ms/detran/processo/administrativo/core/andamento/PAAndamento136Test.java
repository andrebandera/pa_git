 ...
 */
public class PAAndamento136Test {
    
    private static final Logger LOG = Logger.getLogger(PAAndamento136Test.class);
    
    public PAAndamento136Test() {
    }
    
    @Rule
    public PAAndamentoRule myPAAndamentoRuleTest = new PAAndamentoRule(PAAndamentoEnum.ANDAMENTO_136);
    ...
    public void testExecutaEspecifico() {
        ...
        try {
            ...
            if(PAAndamentoProcessoAdministrativoValidoEnum.PA_ENCONTRADO.equals(myPAAndamentoRuleTest.getPaAndamentoValido())) {
                ...
                wrapper.setTipo(TipoFasePaEnum.ENTREGA_CNH);
                
                DtnRESTfulClient clientExecuta 
                    = executaTeste(wrapper, PAAndamentoEnum.ANDAMENTO_136);
    ...
    public void testExecutaEspecificoSemWrapper() {
        ...
        try {
            ...
            if(PAAndamentoProcessoAdministrativoValidoEnum.PA_ENCONTRADO.equals(myPAAndamentoRuleTest.getPaAndamentoValido())) {
                ...
                DtnRESTfulClient clientExecuta 
                    = executaTeste(null, PAAndamentoEnum.ANDAMENTO_136);
