...
public class PAAndamento205Test {
    
    private static final Logger LOG = Logger.getLogger(PAAndamento205Test.class);
    
    public PAAndamento205Test() {
    }
    
    @Rule
    public PAAndamentoRule myPAAndamentoRuleTest = new PAAndamentoRule(PAAndamentoEnum.ANDAMENTO_205);
