 ...
 */
public class PAAndamento135Test {
    
    private static final Logger LOG = Logger.getLogger(PAAndamento135Test.class);
    
    public PAAndamento135Test() {
    }
    
    @Rule
    public PAAndamentoRule myPAAndamentoRuleTest = new PAAndamentoRule(PAAndamentoEnum.ANDAMENTO_135);
    ...
    public void testExecutaEspecifico() {
        ...
        try {
            ...
            if(PAAndamentoProcessoAdministrativoValidoEnum.PA_ENCONTRADO.equals(myPAAndamentoRuleTest.getPaAndamentoValido())) {
                ...
                NotificaProcessoAdministrativoWrapper notificaWrapper = new NotificaProcessoAdministrativoWrapper();
                notificaWrapper.setTipo(TipoFasePaEnum.ENTREGA_CNH);
                
                DtnRESTfulClient clientExecuta 
                    = executaTeste(notificaWrapper, PAAndamentoEnum.ANDAMENTO_135);
    ...
    @Test
    public void testExecutaEspecificoFaseDiferente_ENTREGA_CNH() {
        ...
        try {
            ...
            if(PAAndamentoProcessoAdministrativoValidoEnum.PA_ENCONTRADO.equals(myPAAndamentoRuleTest.getPaAndamentoValido())) {
                ...
                NotificaProcessoAdministrativoWrapper notificaWrapper = new NotificaProcessoAdministrativoWrapper();
                notificaWrapper.setTipo(TipoFasePaEnum.PENALIZACAO);
    ...
    public void testExecutaEspecificoSemWrapper() {
        ...
        try {
            ...
            if(PAAndamentoProcessoAdministrativoValidoEnum.PA_ENCONTRADO.equals(myPAAndamentoRuleTest.getPaAndamentoValido())) {
                ...
                DtnRESTfulClient clientExecuta 
                    = executaTeste(null, PAAndamentoEnum.ANDAMENTO_135);
