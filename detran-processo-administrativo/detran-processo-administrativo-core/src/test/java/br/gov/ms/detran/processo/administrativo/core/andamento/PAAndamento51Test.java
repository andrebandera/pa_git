...
public class PAAndamento51Test {
    
    private static final Logger LOG = Logger.getLogger(PAAndamento51Test.class);
    
    public PAAndamento51Test() {
    }
    
    @Rule
    public PAAndamentoRule myPAAndamentoRuleTest = new PAAndamentoRule(PAAndamentoEnum.ANDAMENTO_51);
