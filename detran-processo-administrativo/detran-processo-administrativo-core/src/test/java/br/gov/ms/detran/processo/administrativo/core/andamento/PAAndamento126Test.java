...
public class PAAndamento126Test {
    
    private static final Logger LOG = Logger.getLogger(PAAndamento126Test.class);
    
    public PAAndamento126Test() {
    }
    
    @Rule
    public PAAndamentoRule myPAAndamentoRuleTest = new PAAndamentoRule(PAAndamentoEnum.ANDAMENTO_126);
    ...
    public void testExecutaEspecifico() {
        ...
        try {
            ...
            if(PAAndamentoProcessoAdministrativoValidoEnum.PA_ENCONTRADO.equals(myPAAndamentoRuleTest.getPaAndamentoValido())) {
                ...
                DtnRESTfulClient clientExecuta = executaTeste(null, PAAndamentoEnum.ANDAMENTO_126);
