 ...
 */
public class PAAndamento128Test {
    
    private static final Logger LOG = Logger.getLogger(PAAndamento128Test.class);
    
    public PAAndamento128Test() {
    }
    
    @Rule
    public PAAndamentoRule myPAAndamentoRuleTest = new PAAndamentoRule(PAAndamentoEnum.ANDAMENTO_128);
