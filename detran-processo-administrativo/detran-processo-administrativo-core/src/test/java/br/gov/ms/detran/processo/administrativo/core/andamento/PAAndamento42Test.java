...
public class PAAndamento42Test {
    
    private static final Logger LOG = Logger.getLogger(PAAndamento42Test.class);
    
    public PAAndamento42Test() {
    }
    
    @Rule
    public PAAndamentoRule myPAAndamentoRuleTest = new PAAndamentoRule(PAAndamentoEnum.ANDAMENTO_42);
