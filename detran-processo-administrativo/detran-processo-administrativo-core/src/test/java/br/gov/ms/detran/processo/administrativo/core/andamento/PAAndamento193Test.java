 ...
 */
public class PAAndamento193Test {
    
    private static final Logger LOG = Logger.getLogger(PAAndamento193Test.class);
    
    public PAAndamento193Test() {
    }
    
    @Rule
    public PAAndamentoRule myPAAndamentoRuleTest = new PAAndamentoRule(PAAndamentoEnum.ANDAMENTO_193);
