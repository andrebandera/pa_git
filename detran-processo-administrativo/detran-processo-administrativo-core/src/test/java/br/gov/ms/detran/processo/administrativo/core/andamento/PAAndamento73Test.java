 ...
 */
public class PAAndamento73Test {
    
    private static final Logger LOG = Logger.getLogger(PAAndamento73Test.class);
    
    public PAAndamento73Test() {
    }
    
    @Rule
    public PAAndamentoRule myPAAndamentoRuleTest = new PAAndamentoRule(PAAndamentoEnum.ANDAMENTO_73);
    ...
    public void testExecutaEspecifico() {
        ...
        try {
            ...
            if(PAAndamentoProcessoAdministrativoValidoEnum.PA_ENCONTRADO.equals(myPAAndamentoRuleTest.getPaAndamentoValido())) {
                ...
                wrapper.setMotivo(MovimentacaoMotivoEnum.RECURSO_ACOLHIDO);
