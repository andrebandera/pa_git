 ...
 */
public class PAAndamento140Test {
    
    private static final Logger LOG = Logger.getLogger(PAAndamento140Test.class);
    
    public PAAndamento140Test() {
    }
    
    @Rule
    public PAAndamentoRule myPAAndamentoRuleTest = new PAAndamentoRule(PAAndamentoEnum.ANDAMENTO_140);
    ...
    public void testExecutaEspecifico() {
        ...
        try {
            ...
            if(PAAndamentoProcessoAdministrativoValidoEnum.PA_ENCONTRADO.equals(myPAAndamentoRuleTest.getPaAndamentoValido())) {
                ...
                EntregaCnhWrapper ecWrapper = new EntregaCnhWrapper();
                ecWrapper.setAcao(AcaoEntregaCnhEnum.DEVOLUCAO);
                
                DtnRESTfulClient clientExecuta 
                    = executaTeste(ecWrapper, PAAndamentoEnum.ANDAMENTO_140);
    ...
    @Test
    public void testExecutaEspecificoAcaoDiferente_DEVOLUCAO() {
        ...
        try {
            ...
            if(PAAndamentoProcessoAdministrativoValidoEnum.PA_ENCONTRADO.equals(myPAAndamentoRuleTest.getPaAndamentoValido())) {
                ...
                EntregaCnhWrapper ecWrapper = new EntregaCnhWrapper();
                ecWrapper.setAcao(AcaoEntregaCnhEnum.ENTREGA);
    ...
    public void testExecutaEspecificoSemWrapper() {
        ...
        try {
            ...
            if(PAAndamentoProcessoAdministrativoValidoEnum.PA_ENCONTRADO.equals(myPAAndamentoRuleTest.getPaAndamentoValido())) {
                ...
                DtnRESTfulClient clientExecuta 
                    = executaTeste(null, PAAndamentoEnum.ANDAMENTO_140);
