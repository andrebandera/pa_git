 ...
 */
public class PAAndamento132Test {
    
    private static final Logger LOG = Logger.getLogger(PAAndamento132Test.class);
    
    public PAAndamento132Test() {
    }
    
    @Rule
    public PAAndamentoRule myPAAndamentoRuleTest = new PAAndamentoRule(PAAndamentoEnum.ANDAMENTO_132);
