...
public class PAAndamento188Test {
    
    private static final Logger LOG = Logger.getLogger(PAAndamento188Test.class);
    
    public PAAndamento188Test() {
    }
    
    @Rule
    public PAAndamentoRule myPAAndamentoRuleTest = new PAAndamentoRule(PAAndamentoEnum.ANDAMENTO_188);
    ...
    public void testExecutaEspecifico() {
        ...
        try {
            ...
            if(PAAndamentoProcessoAdministrativoValidoEnum.PA_ENCONTRADO.equals(myPAAndamentoRuleTest.getPaAndamentoValido())) {
                ...
                DtnRESTfulClient clientExecuta = executaTeste(entrada, PAAndamentoEnum.ANDAMENTO_188);
    ...
    public void testExecutaEspecificoSemWrapper() {
        ...
        try {
            ...
            if(PAAndamentoProcessoAdministrativoValidoEnum.PA_ENCONTRADO.equals(myPAAndamentoRuleTest.getPaAndamentoValido())) {
                ...
                DtnRESTfulClient clientExecuta = executaTeste(null, PAAndamentoEnum.ANDAMENTO_188);
