 ...
 */
public class PAAndamento171Test {
    
    private static final Logger LOG = Logger.getLogger(PAAndamento171Test.class);
    
    public PAAndamento171Test() {
    }
    
    @Rule
    public PAAndamentoRule myPAAndamentoRuleTest = new PAAndamentoRule(PAAndamentoEnum.ANDAMENTO_171);
