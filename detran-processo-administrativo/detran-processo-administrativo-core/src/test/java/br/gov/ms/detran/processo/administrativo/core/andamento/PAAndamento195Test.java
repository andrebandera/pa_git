 ...
 */
public class PAAndamento195Test {
    
    private static final Logger LOG = Logger.getLogger(PAAndamento195Test.class);
    
    public PAAndamento195Test() {
    }
    
    @Rule
    public PAAndamentoRule myPAAndamentoRuleTest = new PAAndamentoRule(PAAndamentoEnum.ANDAMENTO_195);
    ...
    public void testExecutaEspecifico() {
        ...
        try {
            ...
            if(PAAndamentoProcessoAdministrativoValidoEnum.PA_ENCONTRADO.equals(myPAAndamentoRuleTest.getPaAndamentoValido())) {
                ...
                wrapper.setTipo(TipoFasePaEnum.CURSO_EXAME);
    ...
    @Test
    public void testExecutaEspecificoTipoDiferente_CURSO_EXAME() {
