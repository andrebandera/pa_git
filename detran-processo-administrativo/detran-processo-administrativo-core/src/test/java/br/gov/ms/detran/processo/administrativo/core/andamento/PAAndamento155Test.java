...
public class PAAndamento155Test {
    
    private static final Logger LOG = Logger.getLogger(PAAndamento155Test.class);
    
    public PAAndamento155Test() {
    }
    
    @Rule
    public PAAndamentoRule myPAAndamentoRuleTest = new PAAndamentoRule(PAAndamentoEnum.ANDAMENTO_155);
