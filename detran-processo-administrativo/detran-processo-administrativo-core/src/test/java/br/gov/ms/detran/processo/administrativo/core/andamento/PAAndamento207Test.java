 ...
 */
public class PAAndamento207Test {
    
    private static final Logger LOG = Logger.getLogger(PAAndamento207Test.class);
    
    public PAAndamento207Test() {
    }
    
    @Rule
    public PAAndamentoRule myPAAndamentoRuleTest = new PAAndamentoRule(PAAndamentoEnum.ANDAMENTO_207);
    ...
    public void testExecutaEspecifico() {
        ...
        try {
            ...
            if(PAAndamentoProcessoAdministrativoValidoEnum.PA_ENCONTRADO.equals(myPAAndamentoRuleTest.getPaAndamentoValido())) {
                ...
                wrapper.setAcao(MovimentacaoAcaoEnum.SUSPENDER);
                wrapper.setMotivo(MovimentacaoMotivoEnum.PELO_DIRETOR_ADJUNTO);
