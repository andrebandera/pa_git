 ...
 */
public class PAAndamento152Test {
    
    private static final Logger LOG = Logger.getLogger(PAAndamento152Test.class);
    
    public PAAndamento152Test() {
    }
    
    @Rule
    public PAAndamentoRule myPAAndamentoRuleTest = new PAAndamentoRule(PAAndamentoEnum.ANDAMENTO_152);
