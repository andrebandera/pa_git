 ...
 */
public class PAAndamento133Test {
    
    private static final Logger LOG = Logger.getLogger(PAAndamento133Test.class);
    
    private final PAAndamentoEnum andamento = PAAndamentoEnum.ANDAMENTO_133;
    
    public PAAndamento133Test() {
    }
