 ...
 */
public class PAAndamento204Test {
    
    private static final Logger LOG = Logger.getLogger(PAAndamento204Test.class);
    
    public PAAndamento204Test() {
    }
    
    @Rule
    public PAAndamentoRule myPAAndamentoRuleTest = new PAAndamentoRule(PAAndamentoEnum.ANDAMENTO_204);
    ...
    public void testExecutaEspecifico() {
        ...
        try {
            ...
            if(PAAndamentoProcessoAdministrativoValidoEnum.PA_ENCONTRADO.equals(myPAAndamentoRuleTest.getPaAndamentoValido())) {
                ...
                wrapper.setTipo(TipoFasePaEnum.JARI);
    ...
    @Test
    public void testExecutaEspecificoTipoDiferente_JARI() {
