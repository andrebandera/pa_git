 ...
 */
public class PAAndamento149Test {
    
    private static final Logger LOG = Logger.getLogger(PAAndamento149Test.class);
    
    public PAAndamento149Test() {
    }
    
    @Rule
    public PAAndamentoRule myPAAndamentoRuleTest = new PAAndamentoRule(PAAndamentoEnum.ANDAMENTO_149);
