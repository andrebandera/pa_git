 ...
 */
public class PAAndamento163Test {
    
    private static final Logger LOG = Logger.getLogger(PAAndamento163Test.class);
    
    public PAAndamento163Test() {
    }
    
    @Rule
    public PAAndamentoRule myPAAndamentoRuleTest = new PAAndamentoRule(PAAndamentoEnum.ANDAMENTO_163);
    ...
    public void testExecutaEspecifico() {
        ...
        try {
            ...
            if(PAAndamentoProcessoAdministrativoValidoEnum.PA_ENCONTRADO.equals(myPAAndamentoRuleTest.getPaAndamentoValido())) {
                ...
                wrapper.setMotivo(MovimentacaoMotivoEnum.PELO_DIRETOR_PRESIDENTE);
