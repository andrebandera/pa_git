 ...
 */
public class PAAndamento159Test {
    
    private static final Logger LOG = Logger.getLogger(PAAndamento159Test.class);
    
    public PAAndamento159Test() {
    }
    
    @Rule
    public PAAndamentoRule myPAAndamentoRuleTest = new PAAndamentoRule(PAAndamentoEnum.ANDAMENTO_159);
