...
public class PAAndamento187Test {
    
    private static final Logger LOG = Logger.getLogger(PAAndamento187Test.class);
    
    public PAAndamento187Test() {
    }
    
    @Rule
    public PAAndamentoRule myPAAndamentoRuleTest = new PAAndamentoRule(PAAndamentoEnum.ANDAMENTO_187);
    ...
    public void testExecutaEspecifico() {
        ...
        try {
            ...
            if(PAAndamentoProcessoAdministrativoValidoEnum.PA_ENCONTRADO.equals(myPAAndamentoRuleTest.getPaAndamentoValido())) {
                ...
                DtnRESTfulClient clientExecuta = executaTeste(PAAndamentoEnum.ANDAMENTO_187);
    ...
    private DtnRESTfulClient executaTeste(PAAndamentoEnum andamentoEnum) throws AppException {
