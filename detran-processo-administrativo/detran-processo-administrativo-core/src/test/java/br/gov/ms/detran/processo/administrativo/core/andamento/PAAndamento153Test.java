 ...
 */
public class PAAndamento153Test {
    
    private static final Logger LOG = Logger.getLogger(PAAndamento153Test.class);
    
    public PAAndamento153Test() {
    }
    
    @Rule
    public PAAndamentoRule myPAAndamentoRuleTest = new PAAndamentoRule(PAAndamentoEnum.ANDAMENTO_153);
    ...
    public void testExecutaEspecifico() {
        ...
        try {
            ...
            if(PAAndamentoProcessoAdministrativoValidoEnum.PA_ENCONTRADO.equals(myPAAndamentoRuleTest.getPaAndamentoValido())) {
                ...
                wrapper.setTipo(TipoFasePaEnum.PROVIMENTO);
                
                DtnRESTfulClient clientExecuta 
                    = executaTeste(wrapper, PAAndamentoEnum.ANDAMENTO_153);
    ...
    public void testExecutaEspecificoSemWrapper() {
        ...
        try {
            ...
            if(PAAndamentoProcessoAdministrativoValidoEnum.PA_ENCONTRADO.equals(myPAAndamentoRuleTest.getPaAndamentoValido())) {
                ...
                DtnRESTfulClient clientExecuta 
                    = executaTeste(null, PAAndamentoEnum.ANDAMENTO_153);
