 ...
 */
public class PAAndamento134Test {
    
    private static final Logger LOG = Logger.getLogger(PAAndamento134Test.class);
    
    private final PAAndamentoEnum andamento = PAAndamentoEnum.ANDAMENTO_134;
    
    
    public PAAndamento134Test() {
    }
    
    @Rule
    public PAAndamentoRule myPAAndamentoRuleTest = new PAAndamentoRule(andamento);
