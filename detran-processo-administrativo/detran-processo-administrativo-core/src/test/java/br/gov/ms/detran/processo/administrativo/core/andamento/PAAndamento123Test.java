 ...
 */
public class PAAndamento123Test {
    
    private static final Logger LOG = Logger.getLogger(PAAndamento123Test.class);
    
    public PAAndamento123Test() {
    }
    
    @Rule
    public PAAndamentoRule myPAAndamentoRuleTest = new PAAndamentoRule(PAAndamentoEnum.ANDAMENTO_123);
