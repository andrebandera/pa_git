...
public class PAAndamento26Test {
    
    private static final Logger LOG = Logger.getLogger(PAAndamento26Test.class);
    
    public PAAndamento26Test() {
    }
    
    @Rule
    public PAAndamentoRule myPAAndamentoRuleTest = new PAAndamentoRule(PAAndamentoEnum.ANDAMENTO_26);
    ...
    public void testExecutaEspecifico() {
        ...
        try {
            ...
            if(PAAndamentoProcessoAdministrativoValidoEnum.PA_ENCONTRADO.equals(myPAAndamentoRuleTest.getPaAndamentoValido())) {
                ...
                DtnRESTfulClient clientExecuta = executaTeste(entrada, PAAndamentoEnum.ANDAMENTO_26);
    ...
    public void testExecutaEspecificoSemWrapper() {
        ...
        try {
            ...
            if(PAAndamentoProcessoAdministrativoValidoEnum.PA_ENCONTRADO.equals(myPAAndamentoRuleTest.getPaAndamentoValido())) {
                ...
                DtnRESTfulClient clientExecuta = executaTeste(null, PAAndamentoEnum.ANDAMENTO_26);
