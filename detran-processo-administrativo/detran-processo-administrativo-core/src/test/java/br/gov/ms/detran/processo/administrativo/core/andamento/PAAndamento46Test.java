...
public class PAAndamento46Test {
    
    private static final Logger LOG = Logger.getLogger(PAAndamento46Test.class);
    
    public PAAndamento46Test() {
    }
    
    @Rule
    public PAAndamentoRule myPAAndamentoRuleTest = new PAAndamentoRule(PAAndamentoEnum.ANDAMENTO_46);
    ...
    public void testExecutaEspecifico() {
        ...
        try {
            ...
            if(PAAndamentoProcessoAdministrativoValidoEnum.PA_ENCONTRADO.equals(myPAAndamentoRuleTest.getPaAndamentoValido())) {
                ...
                DtnRESTfulClient clientExecuta = executaTeste(entrada, PAAndamentoEnum.ANDAMENTO_46);
    ...
    @Test
    public void testExecutaEspecificoTipoDiferente_PROVIMENTO() {
    ...
    public void testExecutaEspecificoSemWrapper() {
        ...
        try {
            ...
            if(PAAndamentoProcessoAdministrativoValidoEnum.PA_ENCONTRADO.equals(myPAAndamentoRuleTest.getPaAndamentoValido())) {
                ...
                DtnRESTfulClient clientExecuta = executaTeste(null, PAAndamentoEnum.ANDAMENTO_46);
