 ...
 */
public class PAAndamento202Test {
    
    private static final Logger LOG = Logger.getLogger(PAAndamento202Test.class);
    
    public PAAndamento202Test() {
    }
    
    @Rule
    public PAAndamentoRule myPAAndamentoRuleTest = new PAAndamentoRule(PAAndamentoEnum.ANDAMENTO_202);
